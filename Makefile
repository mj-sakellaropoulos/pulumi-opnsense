SHELL            := /bin/bash
PROJECT          := github.com/mj-sakellaropoulos/pulumi-opnsense
NODE_MODULE_NAME := @mj-sakellaropoulos/pulumi-opnsense
TF_NAME          := opnsense
...
TFGEN            := pulumi-tfgen-opnsense
PROVIDER         := pulumi-resource-opnsense
