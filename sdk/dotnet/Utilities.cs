...
namespace Pulumiverse.Opnsense
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/mj-sakellaropoulos/pulumi-opnsense";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Opnsense.version.txt");
    ...
    internal sealed class OpnsenseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public OpnsenseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
